...
#[AllowDynamicProperties]
 class TGMRequiredPlugins {
	...
	public function car_repair_services_register_required_plugins() {
		...
		$plugins = array(
			 array(
				'name'         => esc_html__('Car Repair Services Core', 'car-repair-services'), // The plugin name
				'slug'         => 'car-repair-services-core', // The plugin slug (typically the folder name)
				'source'       => get_template_directory_uri() . '/framework/download-plugin.php?plugin=car-repair-services-core', // The plugin source
				//'version'      => '4.10', // E.g. 1.0.0. If set, the active
				'required'     => true, // If false, the plugin is only 'recommended' instead of required
				'external_url' => '', // If set, overrides default API URL and points to an external URl
			),
			array(
				'name'         => esc_html__('Car Repair Demo Installer', 'car-repair-services'), // The plugin name
				'slug'         => 'car-repair-demo-installer', // The plugin slug (typically the folder name)
				'source'       => get_template_directory_uri() . '/framework/download-plugin.php?plugin=car-repair-demo-installer', // The plugin source
				//'version'      => '3.1', // E.g. 1.0.0. If set, the active
				'required'     => true, // If false, the plugin is only 'recommended' instead of required
				'external_url' => '', // If set, overrides default API URL and points to an external URl
			),
			array(
				'name'         => esc_html__('Estimate Plugin', 'car-repair-services'), // The plugin name
				'slug'         => 'estimate-plugin', // The plugin slug (typically the folder name)
				'source'       => get_template_directory_uri() . '/framework/download-plugin.php?plugin=estimate-plugin', // The plugin source
				//'version'      => '3.1', // E.g. 1.0.0. If set, the active
				'required'     => true, // If false, the plugin is only 'recommended' instead of required
				'external_url' => '', // If set, overrides default API URL and points to an external URl
			),
